; Lab2 Q11 : Right shift by 2 bits
section .data
	msg db "After Right Shift , value = "
	len equ $ - msg
	nl db 10             ;assigning value to variable n1
	StrAns db '000'     ;answer string
    len2 equ $ - StrAns
...
_start: 
	mov eax, 996       ; Number to be right shifted is selected
	mov ebx, 4         
	div ebx            ; Selected number is divided by 4 
