;LAB 2 :Q8 - OR operation

section .data              ;assigns all constant values
   msg3 db "OR operation result : "
   len3 equ $-msg3         ;allocates length of msg3 to len3

   msg db 0xA
   n1 db '303'            ;assigning n1 as number 1
   n2 db '101'            ;assigning value of number 2
   or_ db ' '            ;creating a variable or_ whose value will be determined by the end 
...
or_function:
   ...
   mov bl,[n2+esi] 
   sub bl,'0'
   or al,bl               ;or operation on the digits in same position of n1 and n2
   add al,'0'

   mov [or_+esi],al       ;store digit in and_
