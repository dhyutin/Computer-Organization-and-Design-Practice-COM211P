;Lab 2 Q4: divide 2 positive 3-digit numbers in the range [100,999] 
...
_start: 
	...
	mov ebx, 003     ; number 2
	div ebx          ; divides number 1 of eax register with number 2 of ebx register and stores in integer value
